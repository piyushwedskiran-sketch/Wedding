...
function scheduleOpeningMessage(delay = 180) {
...
let sparks = [];
let nextBurst = 0;
const canAnimateFireworks = !matchMedia('(prefers-reduced-motion: reduce)').matches;
